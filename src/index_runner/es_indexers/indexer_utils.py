...
def is_workspace_public(ws_id):
    ...
    """
    ws_info = ws_utils.get_workspace_info({'id': ws_id})
...
def get_shared_users(ws_id):
    ...
    """
    obj_perm = ws_utils.get_permissions_mass({
        'workspaces': [{'id': ws_id}]
    })['perms'][0]
...
def default_fields(obj_data, ws_info, obj_info_v1):
    """
